<h4>Tambah Pengeluaran</h4>
	...
	<?php } ?>
<a href="<?=base_url('keluar');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar Pengeluaran</button></a>
<form action="<?=base_url('keluar/tambah_pengeluaran');?>" method="POST">
