...
<h4>Tambah Piutang</h4>
	...
	<?php } ?>
<a href="<?=base_url('piutang');?>"><button type="button" class="btn btn-primary">Kembali ke Daftar Piutang</button></a>
<form action="<?=base_url('piutang/tambah_piutangmasuk');?>" method="POST">
